 ...
 *
 * La configuration Claude et Codex est écrite par `./client-config.cjs`,
 * propre à ce dépôt : écriture atomique, détection de conflit et
 * réversibilité, sous l'identifiant de bloc `piecemaker_proxy`.
 */
