...
def scan_file(md_file: str, output_dir: str) -> str:
    ...
    # One stderr line per entity is 3 586 lines on ALPHABIO_URD. A parent that does not
    ...
    # ALPHABIO_URD, e.g. LOCATION "French" inside ORGANIZATION "French Monetary and
