...
- Handles both exact duplicates and variations (e.g., "Mr. Dupont" vs "Jean Dupont")
- For each group:
...
{
  "mapping": {
    "Mr. Dupont": "PERSONNE_PHYSIQUE_03",
    "mr. gilly": "PERSONNE_PHYSIQUE_03",
    "Mr. Dupont": "PERSONNE_PHYSIQUE_04",  // duplicate gets different code
    "mr. gilly": "PERSONNE_PHYSIQUE_04",
    "Mr.  Dupont": "PERSONNE_PHYSIQUE_05",
    "mr.  gilly": "PERSONNE_PHYSIQUE_05",
    "Jean Dupont": "PERSONNE_PHYSIQUE_08"
  }
}
```
...
{
  "mapping": {
    "Jean Dupont": "PERSONNE_PHYSIQUE_03",
    "Mr. Dupont": "PERSONNE_PHYSIQUE_03",
    "Mr.  Dupont": "PERSONNE_PHYSIQUE_03",
    "Mr.Dupont": "PERSONNE_PHYSIQUE_03"
  },
  "extracted_data": {
    "personnes_physiques": {
      "PERSONNE_PHYSIQUE_03": {
        ...
        "variants": ["Jean Dupont", "Mr. Dupont", "Mr.  Dupont", "Mr.Dupont"],
        "score": 0.95,
...
3. **Spacing variations handled**: "Mr. Dupont" vs "Mr.  Dupont" vs "Mr.Dupont" → same code
4. **Name variations consolidated**: "Mr. Dupont" vs "Jean Dupont" → same code
5. **Longest variant as canonical**: "Jean Dupont" (longest) chosen over "Mr. Dupont"
...
- "Mr. Dupont" (appears twice) + "Mr.  Dupont" + "Jean Dupont" + "Mr.Dupont" → single entity
- Canonical form: "Jean Dupont" (longest)
- Score: 0.95 (highest)
