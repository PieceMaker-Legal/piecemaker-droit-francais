...
export function startInstallerStack(runtime, report) {
  ...
  if (!fs.existsSync(entry)) {
    report.warn('Socle PieceMaker Installer introuvable — proxy PII et administration non démarrés');
    return { started: false };
  }

  report.step('Socle — démarrage du proxy PII et de l administration');
