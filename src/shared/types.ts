...
export type LLMProvider = 'claude' | 'cursor' | 'codex' | 'opencode' | 'mistral';
...
export type AppTab = 'chat' | 'files' | 'shell' | 'git' | 'tasks' | 'browser' | 'dossier' | `plugin:${string}`;
...
export type SettingsMainTab = 'agents' | 'appearance' | 'git' | 'api' | 'voice' | 'tasks' | 'browser' | 'notifications' | 'uninstall' | 'plugins' | 'about';
