...
export default function AboutTab() {
  ...
  const { updateAvailable, latestVersion, currentVersion, releaseInfo } = useProductVersionCheck();
  const releasesUrl = releaseInfo?.htmlUrl || `${PRODUCT_REPOSITORY_URL}/releases`;
