...
describe('MappingModel', () => {
  it('regroupe le mapping plat par nom anonymisé', () => {
    expect(groupMappingByCode({
      ...
      { code: 'PERSONNE_PHYSIQUE_01', principal: 'Jean Dupont', variants: ['M. Dupont'] },
  ...
  it('conserve le premier reverse mapping comme variant principal', () => {
    const source = {
      mapping: { 'M. Dupont': 'PERSONNE_PHYSIQUE_01', 'Jean Dupont': 'PERSONNE_PHYSIQUE_01' },
      reverse_mapping: { PERSONNE_PHYSIQUE_01: ['Jean Dupont', 'M. Dupont'] },
    };
  ...
  it('refuse un variant affecté à deux codes', () => {
    expect(() => buildMappingDocument([
      { code: 'PERSONNE_PHYSIQUE_01', principal: 'Jean Dupont', variants: ['M. Dupont'] },
      { code: 'PERSONNE_PHYSIQUE_02', principal: 'Claire Dupont', variants: ['M. Dupont'] },
