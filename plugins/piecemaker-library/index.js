...
export function mount(container, api) {
  ...
  style.textContent = `
    ...
    .pm-library nav,.pm-library .toolbar{display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin:20px 0}.pm-library nav[role=tablist]{display:inline-flex;width:max-content;flex-wrap:nowrap;gap:3px;padding:3px;border:1px solid hsl(var(--border, 0 0% 87%));border-radius:999px;background:hsl(var(--muted, 0 0% 93%));box-shadow:0 1px 3px rgba(0,0,0,.08)}
