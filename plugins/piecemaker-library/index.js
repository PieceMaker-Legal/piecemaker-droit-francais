...
export function mount(container, api) {
  ...
  style.textContent = `
    ...
    .pm-library nav[role=tablist] button,.pm-library .pills button{border:0;border-radius:999px;padding:6px 12px;background:transparent}.pm-library nav[role=tablist] button:hover,.pm-library .pills button:hover{background:rgb(255 255 255 / 12%)}.pm-library nav[role=tablist] button[aria-selected=true],.pm-library .pills button[aria-selected=true]{background:transparent;box-shadow:inset 0 0 0 1px rgb(var(--mike-ink-rgb) / 26%);font-weight:600}
