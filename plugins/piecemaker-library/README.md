...
- Les skills, plugins, agents et MCP importés sont désactivés au départ. Un toggle persiste une activation unique pour le chemin canonique du dossier ; le backend matérialise les formats partagés reconnus par Claude, Codex, Cursor, Mistral et OpenCode et ajoute les instructions aux prochains messages. Les instructions d’agents sont des rôles transmis au modèle, sans création automatique de sous-processus agent.
