...
- L’installation ajoute par défaut le connecteur PERS_MORALE_1 gratuit de Registre Public (`https://registre-public.com/api/mcp`) aux configurations utilisateur de Claude et Codex. Il apparaît dans l’onglet Connecteurs et reste désactivable par dossier.
